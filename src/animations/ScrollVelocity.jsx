    ...
    for (let i = 0; i < numCopies; i++) {
      spans.push(
        <span
          ...
          className="font-Anton flex-shrink-0 px-8 text-2xl md:text-5xl 2xl:text-[96px] italic uppercase text-transparent [-webkit-text-stroke:1px_white] 3xl:text-[200px]"
        >
          {children}
        </span>
      );
