...
export default function FlatInteriors221GalleryHero() {
  return (
    <section
      id="featured"
      className="relative flex flex-col  gap-8 bg-black text-white overflow-hidden h-screen 3xl:gap-[120px]"
    >
      {/* Container */}
      <div
      ...
      >
        ...
        <motion.h1
          ...
          "
        >
          <span className="block 3xl:mb-6">Flat Interiors</span>
          <span className="block 3xl:mb-6">#221</span>
        </motion.h1>
      </div>
      ...
      <div className="w-full bg-black/80 flex justify-end md:justify-end p-8 pb-0 z-20 3xl:pb-8">
        <div className="text-left border-b border-white/30 p-3 3xl:p-6">
          {/* Wrapper with right margin alignment (like Villa22) */}
