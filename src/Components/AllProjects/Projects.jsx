...
const projects = [
  { id: 1, title: "2 Star Bio-Hotel", year: "2020", image: "https://cdn.cosmos.so/7d47d4e2-0eff-4e2f-9734-9d24a8ba067e?format=jpeg" },
  { id: 2, title: "Apartment #746", year: "2022", image: "https://cdn.cosmos.so/5eee2d2d-3d4d-4ae5-96d4-cdbae70a2387?format=jpeg" },
  { id: 3, title: "Apartment Complex", year: "2019", image: "https://cdn.cosmos.so/def30e8a-34b2-48b1-86e1-07ec5c28f225?format=jpeg" },
  { id: 4, title: "Bio-Hotel", year: "2020", image: "https://cdn.cosmos.so/44d7cb23-6759-49e4-9dc1-acf771b3a0d1?format=jpeg" },
  { id: 5, title: "Conceptual Farmhouse", year: "2021", image: "https://cdn.cosmos.so/7712fe42-42ca-4fc5-9590-c89f2db99978?format=jpeg" },
  { id: 6, title: "Conceptual Museum Design", year: "2017", image: "https://cdn.cosmos.so/def30e8a-34b2-48b1-86e1-07ec5c28f225?format=jpeg" },
  { id: 7, title: "Condominium Apartment #52", year: "2021", image: "https://cdn.cosmos.so/44d7cb23-6759-49e4-9dc1-acf771b3a0d1?format=jpeg" },
  { id: 8, title: "Condominium Karma Residence", year: "2022", image: "https://cdn.cosmos.so/7d47d4e2-0eff-4e2f-9734-9d24a8ba067e?format=jpeg" },
  { id: 9, title: "High Rise Apartment Complex", year: "2018", image: "https://cdn.cosmos.so/5eee2d2d-3d4d-4ae5-96d4-cdbae70a2387?format=jpeg" },
  { id: 10, title: "House #42", year: "2023", image: "https://cdn.cosmos.so/7712fe42-42ca-4fc5-9590-c89f2db99978?format=jpeg" },
  { id: 5, title: "Conceptual Farmhouse", year: "2021", image: "https://cdn.cosmos.so/7712fe42-42ca-4fc5-9590-c89f2db99978?format=jpeg" },
  { id: 6, title: "Conceptual Museum Design", year: "2017", image: "https://cdn.cosmos.so/def30e8a-34b2-48b1-86e1-07ec5c28f225?format=jpeg" },
  { id: 7, title: "Condominium Apartment #52", year: "2021", image: "https://cdn.cosmos.so/44d7cb23-6759-49e4-9dc1-acf771b3a0d1?format=jpeg" },
  { id: 8, title: "Condominium Karma Residence", year: "2022", image: "https://cdn.cosmos.so/7d47d4e2-0eff-4e2f-9734-9d24a8ba067e?format=jpeg" },
