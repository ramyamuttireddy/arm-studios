  ...
  return (
    <section
      ...
      className="
        ...
        hero-top-padding
        3xl:gap-[300px] 3xl:min-h-[3000px]
      "
    >
      {/* Container */}
      <div
        className="
          hero-container w-full max-w-[1200px] mx-auto p-5 pt-40 md:px-12 lg:px-20 flex gap-10 justify-center h-full
          xl:p-30 xl:gap-20
          3xl:max-w-[2400px] 3xl:gap-[100px] 3xl:px-[60px] 3xl:pt-[300px]
        "
      >
        {/* Section Counter */}
        <motion.div
          ...
          className="
            hero-counter text-white text-2xl sm:text-4xl md:text-5xl font-serif italic xl:text-[50px] 2xl:text-[96px]
            fade-in text-right
            3xl:text-[180px] 3xl:leading-[180px]
          "
        >
          8
        </motion.div>
        ...
        <motion.h1
          ...
          className="
            hero-headline leading-[50px] uppercase text-4xl sm:text-6xl md:text-7xl lg:text-8xl xl:text-[110px] font-medium
            3xl:text-[220px] 3xl:leading-[200px]
          "
        >
          <span className="block 3xl:mb-6">We design</span>
          <span className="block 3xl:mb-6">unique</span>
          <span className="block 3xl:mb-6">web graphic</span>
          <span className="block 3xl:mb-6">experienc</span>
        </motion.h1>
