function About() {
  return (
    <>
      <div class="relative m-auto w-full 2xl:w-[80%] py-12 md:py-16 lg:py-20 xl:py-24 bg-black text-white overflow-hidden fade-in flex flex-col justify-end items-end ">
        <div class="px-4 sm:px-3 md:px-8 lg:px-10 xl:px-12">
          <div class="flex gap-[20px] md:gap-[50px]">
            <div class="pt-4 text-4xl font-light italic md:text-5xl md:pt-10 ">
              02
            </div>
            <div class="text-4xl text-white font-medium uppercase border-b border-white pb-[30px] w-[100%] md:pb-[50px] md:text-8xl">
              About us
            </div>
          </div>

          <div class="pt-10 pl-[38px] pb-10 text-[16px] font-normal md:pl-[100px] md:pt-16 md:pb-14 lg:pb-34 lg:text-[30px] lg:pb-[134px]">
            <p class="pb-4">
          ...
          <div class="flex flex-col gap-[30px] lg:flex-row lg:gap-[20px]">
            <div class="p-[0px_15px]">
              <img
                src="/assets/img/Flat Interiors 221.png"
                alt=""
                class="lg:max-w-[504px] lg:h-[508px]"
              />
            </div>
            <div class="pl-[38px] flex flex-col gap-[40px] lg:flex-col-reverse lg:gap-[100px]">
              <div class="bg-[#0100fc] p-[45px_25px] mt-[-70px] lg:ml-[-150px] lg:mr-[80px] lg:w-[700px]">
                <div class="flex justify-between font-medium border-b border-white pb-[20px]">
                  <div class="text-[16px] lg:text-[36px]">Project 3</div>
                ...
                <div class="flex justify-between font-medium border-b border-white pb-[20px] pt-[20px]">
                  <div class="text-[16px] lg:text-[36px]">Project 3</div>
                  <div class="text-[16px] lg:text-[20px]">
                    <div>it is a long</div>
                    <div>established fact</div>
                ...
                <div class="flex justify-between font-medium pt-[20px]">
                  <div class="text-[16px] lg:text-[36px]">Project 3</div>
                  <div class="text-[16px] lg:text-[20px]">
                    <div>it is a long</div>
                    <div>established fact</div>
              ...
              <div class="flex flex-col gap-4 text-base font-normal pb-[30px] lg:text-[20px] lg:leading-7">
                <p>
