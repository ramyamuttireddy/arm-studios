function About() {
  return (
    <>
      <div className="about-container  py-12 md:py-16 lg:py-20 xl:py-24 bg-black text-white overflow-hidden fade-in flex flex-col justify-center mx-auto">
        <div className="px-4 sm:px-3 md:px-8 lg:px-10 xl:px-12">
          <div className="flex gap-[20px] md:gap-[50px]">
            <div className="pt-4 text-4xl font-light italic md:text-5xl md:pt-10 2xl:text-[90px] text-center">
              02
            </div>
            <div className="text-4xl text-white font-medium uppercase border-b border-white pb-[30px] w-[100%] md:pb-[50px] md:text-8xl">
              About us
            </div>
          </div>

          <div className="abou-text pt-10 pl-[38px] pb-10 text-[16px] font-normal md:pl-[100px] md:pt-16 md:pb-14 lg:pb-34 lg:text-[30px] lg:pb-[134px]">
            <p className="pb-4">
          ...
          <div className="flex flex-col gap-[30px] lg:flex-row lg:gap-[20px]">
            <div className="p-[0px_15px]">
              <img
                src="/assets/img/Flat Interiors 221.png"
                alt=""
                className="lg:max-w-[504px] lg:h-[508px]"
              />
            </div>
            <div className="pl-[38px] flex flex-col gap-[40px] lg:flex-col-reverse lg:gap-[100px]">
              <div className="project-box bg-[#0100fc] p-[45px_25px] mt-[-70px] lg:ml-[-150px] lg:mr-[80px] lg:w-[700px]">
                <div className="flex justify-between font-medium border-b border-white pb-[20px]">
                  <div className="text-[16px] lg:text-[36px]">Project 3</div>
              ...
              <div className="flex flex-col gap-4 text-base font-normal pb-[30px] lg:text-[20px] lg:leading-7 about-text">
                <p>
