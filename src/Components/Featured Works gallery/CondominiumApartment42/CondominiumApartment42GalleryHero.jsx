...
export default function CondominiumApartment42GalleryHero() {
  return (
    <section
      id="featured"
      ...
      <div>
        ...
        >
          ...
          <motion.h1
            ...
            "
          >
            <span className="block 3xl:mb-6">Condominium</span>
            <span className="block 3xl:mb-6">Apartment #42</span>
          </motion.h1>
        </div>
