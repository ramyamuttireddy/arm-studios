...
export default function ConceptualSkyscraper25GalleryHero() {
  return (
    <section
      id="featured"
      ...
      <div>
        ...
        >
          ...
          <motion.h1
            ...
            "
          >
            <span className="block 3xl:mb-6">Conceptual</span>
            <span className="block 3xl:mb-6">Skyscraper #25</span>
          </motion.h1>
        </div>
