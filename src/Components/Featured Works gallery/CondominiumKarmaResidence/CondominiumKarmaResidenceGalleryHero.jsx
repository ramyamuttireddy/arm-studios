...
export default function CondominiumKarmaResidenceGalleryHero() {
  return (
    <section
      id="featured"
      ...
      <div>
        ...
        >
          ...
          <motion.h1
            ...
            "
          >
            <span className="block 3xl:mb-6">Condominium Karma</span>
            <span className="block 3xl:mb-6">Residence</span>
          </motion.h1>
        </div>
