...
export default function VillaEntranceGalleryHero() {
  return (
      <section
      id="featured"
      className="relative flex flex-col gap-40 bg-black text-white overflow-hidden h-[80vh] lg:h-screen 3xl:gap-[120px]"
    >
      {/* Container */}
      <div
        className="
