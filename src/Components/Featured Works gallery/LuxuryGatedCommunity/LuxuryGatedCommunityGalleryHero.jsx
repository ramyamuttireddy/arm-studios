...
export default function LuxuryGatedCommunityGalleryHero() {
  return (
    <section
      id="featured"
      ...
      <div>
        ...
        >
          ...
          <motion.h1
            ...
            "
          >
            <span className="block 3xl:mb-6">Luxury Gated</span>
            <span className="block 3xl:mb-6">Community</span>
          </motion.h1>
          ...
          {/* <div className="absolute top-1/2 right-10 hidden md:block">
            <img
              ...
              alt="hover"
              className="hover-img w-48 opacity-0 hover:opacity-100 transition duration-700 3xl:w-[96px]"
            />
          </div> */}
        </div>
