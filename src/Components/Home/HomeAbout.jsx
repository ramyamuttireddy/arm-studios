function HomeAbout() {
  return (
    <div>
      <div className="py-20  w-full flex flex-col p-10  md:flex-row gap-4 md:gap-10 lg:gap-10   mb-8 md:mb-12 lg:mb-1 3xl:gap-[40px] 3xl:mb-[80px]">
        {/* Left side -> 02 */}
        <div
          className="w-full lg:w-[30%] 2xl:w-[45%] hero-counter text-white text-2xl sm:text-4xl md:text-5xl italic xl:text-[50px] 2xl:text-[64px]
            fade-in text-left md:text-right 3xl:text-[180px] 3xl:leading-[180px] font-Cormorant"
        >
        ...
        <div className="px-0   flex flex-col  w-full xl:w-[100%] 2xl:w-[100%]">
          ...
          <div className="border-b-2 w-full pb-2 mb-6">
            <h2
              className=" hero-headline leading-tight uppercase text-4xl sm:text-6xl md:text-7xl lg:text-6xl xl:text-[75px] 2xl:text-[90px] font-medium
          ...
          <div className="font-sans pt-10 pb-10 text-[16px] font-normal md:pt-16 md:pb-14 lg:text-[20px] xl:text-[18px] lg:pb-[134px] 3xl:text-[48px] 3xl:leading-[1.4]">
            <p className="pb-4">
              ARM STUDIOS offers 15+ years of experience to the Deccan Plateaus
              Community. Recognized for our commitment and passion for the
              Bharatiya Continent, our team continues to make contributions as
              architects, developers, philanthropists! After founding the firm,
              Founding Principal Moganti Deepak welcomed Dr.Devakanth Pulicherla
              in 2023 as the firm’s second principal. In 2025, Naidu Babu
              Rongali joined as firm Design Principal. Today, ARM STUDIOS team
              of architects, designers and creative thinkers brings an unmatched
              level of diligence and youthful enthusiasm to each project.
            </p>
          </div>
